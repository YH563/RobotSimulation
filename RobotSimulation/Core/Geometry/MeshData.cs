...
/// 转换为 Core.Rendering.Mesh 所需的交错 float[]（pos3|uv2|normal3|tangent3）。
/// </summary>
public sealed class MeshData
{
    ...
    /// <summary>
    /// 导出为 Core.Rendering.Mesh 构造所需的交错顶点数组：
    /// 每个顶点占 11 个 float，顺序为 pos(3) | uv(2) | normal(3) | tangent(3)。
    /// </summary>
    public float[] ToInterleavedArray()
    {
        var result = new float[VertexCount * 11];
        int i = 0;
